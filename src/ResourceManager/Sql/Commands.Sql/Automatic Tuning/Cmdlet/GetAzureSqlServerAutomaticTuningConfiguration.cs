...
{
    [Cmdlet(VerbsCommon.Get, "AzureRmSqlServerAutomaticTuningConfiguration")]
    public class GetAzureSqlServerAutomaticTuningConfiguration : AzureSqlServerAutomaticTuningCmdletBase
    {
        /// <summary>
        ...
        {
            ICollection<AzureSqlServerAutomaticTuningModel> results;

            results = new List<AzureSqlServerAutomaticTuningModel>();
            results.Add(ModelAdapter.GetServerSettings(this.ResourceGroupName, this.ServerName));
