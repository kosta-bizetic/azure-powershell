...
{
    public abstract class AzureSqlServerAutomaticTuningCmdletBase : AzureSqlCmdletBase<IEnumerable<AzureSqlServerAutomaticTuningModel>, AzureSqlAutomaticTuningAdapter>
    {
        /// <summary>
